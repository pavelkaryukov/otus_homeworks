...
void TestCanvas() {
    ...
    app.AddShape(std::make_unique<Circle   >(TCoord(0, 12), TCoord(22, 34), 1, TColor(0xf0, 0xFF, 0x82, 0x34)));
    app.AddShape(std::make_unique<Line     >(TCoord(10, 78), TCoord(85, 129), 45, TColor(0x23, 0x7a, 0xbc, 0xde)));
    app.AddShape(std::make_unique<Rectangle>(TCoord(8, 99), TCoord(0xde, 87), 9, TColor(0x23, 0x7a, 0xaa, 0xb2)));
    app.Clear();
